...
public class CarRates  extends VehicleRates
{
    ...
    private double mileageChrg = 0.15;
    private double dailyInsurRate = 14.95;

    public CarRates(double dailyRate, double weeklyRate, double monthlyRate, double mileageChrg, double dailyInsurRate) {
